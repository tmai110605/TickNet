...
def main():
    ...
    for typesize in arr_typesize_groups:  
        strmode = 'NetTOP_used_groups_' + str(typesize)  
        pathout = './checkpoints/CIFAR10_NetTOP/' + strmode
        ...
        model = build_TickNetv7(120, cifar=False, typesize='small', drop_path_max=0.10, dropout=0.20)
