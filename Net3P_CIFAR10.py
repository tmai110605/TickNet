...
from models.TickNet import build_TickNet_BESTvg
...
def get_data_loader(args, train):
    if args.dataset in ('cifar10', 'cifar100'):
        ...
        dataset_class = StanfordDogs # Import từ models.datasets
    else:
...
def main():
    ...
    for typesize in arr_typesize:    
        strmode = 'StanfordDogs_TickNet_' + typesize + '_MAF'  
       ...
       # model =model = build_TickNet_BESTvg(120, cifar=False)
        model = build_TickNet_BESTvg(100, cifar=True, g=1, operator=op)
